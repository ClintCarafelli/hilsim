...
import pytest
from hilsim.core.controls import AdvancedCommunication
...
@pytest.fixture
def single_device_config(device_config: dict, device_id: str) -> dict:
    """Pull the device_config dictonary"""
    return device_config["devices"][device_id]


@pytest.fixture
def error_handling_config(device_config: dict) -> dict:
    """Pull the device_config dictonary"""
    print(device_config)
    return device_config["advanced_communication"]


@pytest.fixture
def ac(
    single_device_config: dict, error_handling_config: dict, device: MagicMock
) -> AdvancedCommunication:
    """Construct an instance of the AdvancedCommunication clas"""
    return AdvancedCommunication(single_device_config, error_handling_config, device)
